#!/bin/bash
tput setaf 7 ; tput bold ; echo "Remover Usuário SSH" ; tput sgr0
		echo ""
		...
		if [[ -z $user ]]
		then
			tput setaf 1 ; tput bold ; echo "" ; echo "Você digitou um nome de usuário vazio ou inválido!" ; echo "" ; tput sgr0
			sleep 4
			menu
			#exit 1
		else
			...
			then
				...
				then
					...
					tput setaf 2 ; tput bold ; echo "" ; echo "O usuário $user foi removido com sucesso!" ; echo "" ; tput sgr0
				...
				tput setaf 1 ; tput bold ; echo "" ; echo "O usuário $user não existe!" ; echo "" ; tput sgr0
			fi
		fi
		sleep 4
		menu
